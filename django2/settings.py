...
SECRET_KEY = '3mc=a%gr)t_m6q3_(p@d6(-$+pjj+zc8jp-=t5hylbr5ce^m3i'
...
# Configurações de e-mail (testes)
# EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'

"""
#  Quando se tem um servidor de e-mail configurado no servidor:
EMAIL_HOST = 'localhost' # geralmente
EMAIL_HOST_USER = 'no-reply@seudominio.com.br'
EMAIL_PORT = 587  # geralmente informado pelo host
EMAIL_USER_TSL = True
